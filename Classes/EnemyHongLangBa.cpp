...
EnemyHongLangBa::EnemyHongLangBa(string jsonFile, string atlasFile, float scale):BaseEnemy(jsonFile, atlasFile,scale)
{
}

EnemyHongLangBa * EnemyHongLangBa::create(string jsonFile, string atlasFile, float scale)
{
	EnemyHongLangBa *enemy = new EnemyHongLangBa(jsonFile, atlasFile,scale);
	enemy->update(0.0f);
...
EnemyHongLangBa * EnemyHongLangBa::create(string filename, float scale)
{
	...
	auto enemy = new EnemyHongLangBa(data);
	enemy->update(0.0f);
	enemy->setTag(TAG_ENEMY_HONGLANGBA1);
	enemy->setScaleX(1);
	enemy->setAnimation(0, "idle", true);
...
//void EnemyHongLangBa::genSplash()
//{
